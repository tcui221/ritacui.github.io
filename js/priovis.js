...
PrioVis.prototype.wrangleData = function(){
    ...
    vis.filteredData.forEach(function(filteredData){
        d3.range(0,15).forEach(function(i){
            votesPerPriority[i] += filteredData["priorities"][i];
        });
    });
...
PrioVis.prototype.updateVis = function(){
    ...
    vis.svg.select(".x-axis").call(vis.xAxis)
        ...
        .text(function(i){
            console.log( vis.metaData["choices"][101])
            return i + ') ' + vis.metaData["choices"][100+i]
        });
